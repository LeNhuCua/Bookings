...
var KTApp = function () {
    ...
    var initDaterangepicker = function() {
        ...
        elements.map(function (element) {
            var display = element.querySelector('input');
            ...
            $(element).daterangepicker({
                ...
                ranges: {
                    ...
                    'Bảy ngày qua': [moment().subtract(6, 'days'), moment()],
                    'Ba mươi ngày qua': [moment().subtract(29, 'days'), moment()],
                    'Bảy ngày tới': [moment(), moment().add(6, 'days')],
