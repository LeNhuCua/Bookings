...
const createCustomerDOM = (data) => {
    ...
    return `
        ...
        <div class="row mb-7">
            ...
            <div class="col-xl-8 form-group fv-row">
        ...
        <div class="row form-group mb-7">
            <div class="col-xl-6">
                ...
                <div class="form-check form-switch form-check-custom form-check-solid">
                    <input name="Status" checked class="form-check-input" value="true" type="checkbox" />
...
const editCustomerDOM = (item, data, customerId) => {
    ...
    return `
        ...
        <div class="row mb-7">
            ...
            <div class="col-xl-4 form-group fv-row">
                <label class="control-label fs-6 fw-bold mb-2">Ngày sinhff</label>
        ...
        <div class="row mb-7">
            <div class="col-xl-4 form-group fv-row">
                 <label class="control-label fs-6 fw-bold mb-2">Số điện thoại</label>
                 <input type="tel" name="Phone" value="${item.phone || ""}" class="form-control form-control-solid mb-3 mb-lg-0"/>
            </div>
            <div class="col-xl-8 form-group fv-row">
                <label class="control-label fs-6 fw-bold mb-2">Địa chỉ</label>
